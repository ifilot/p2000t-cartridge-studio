 ...
 */
CartridgeStudioApplication::CartridgeStudioApplication(int& argc, char** argv) :
 ...
 */
bool CartridgeStudioApplication::notify(QObject* receiver, QEvent* event) {
    bool done = true;
    try {
 ...
 */
void CartridgeStudioApplication::throw_message_window(const QString& title, const QString& message) {
    QMessageBox message_box;
    message_box.setText(message);
    message_box.setIcon(QMessageBox::Critical);
    message_box.setWindowTitle(title);
    message_box.setWindowIcon(QIcon(PROGRAM_ICON));
    message_box.exec();
}
