...
but their version numbers do not need to be equal to communicate. Studio 0.2.5
...
| 0.2.3 | 0.1.0, 0.1.1, 0.1.2, 0.2.0, 0.2.1, 0.2.2, 0.2.3 | The serial command set is unchanged; 0.2.3 improves bank-selector DIP-switch guidance. |
| 0.2.4 | 0.1.0, 0.1.1, 0.1.2, 0.2.0, 0.2.1, 0.2.2, 0.2.3, 0.2.4 | The serial command set is unchanged; 0.2.4 adds drag-and-drop ROM opening. |
| 0.2.5 | 0.1.0, 0.1.1, 0.1.2, 0.2.0, 0.2.1, 0.2.2, 0.2.3, 0.2.4, 0.2.5 | The serial command set is unchanged; 0.2.5 fixes the bank grid and DIP-switch order. |
...
command protocol and are therefore outside this matrix. Studio 0.2.5 validates
